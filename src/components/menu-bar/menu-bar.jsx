                    ...
                    <div className={styles.fileGroup}>
                        ...
                        >
                            ...
                            >
                                ...
                                {/* kani robot */}
                                <MenuSection>
                                    <RubyDownloader>{(className, _, saveRubyCode) => (
                                        <MenuItem
                                            className={className}
                                            onClick={this.handleCloseFileMenuAndThen(saveRubyCode)}
                                        >
                                            <FormattedMessage
                                                defaultMessage="Write Ruby to Microcomputer"
                                                description="Menu bar item for writing Ruby code to microcomputer"
                                                id="gui.smalruby3.menuBar.WriteRubyToMicrocomputer"
                                            />
                                        </MenuItem>
                                    )}</RubyDownloader>
                                </MenuSection>
