...
import kaniImage from './kanirobot.png';	// kani robot
...
import kaniPeripheralImage from './peripheral-connection/microbit/microbit-illustration.svg';	// kani robot
import kaniMenuImage from './peripheral-connection/kanirobot/sample-small.svg';	//  kani robot
...
export default [
    ...
    {
        name: 'kani robot',
        extensionId: 'kanirobot',
        collaborator: 'kani robot',
        iconURL: kaniImage,
        insetIconURL: kaniMenuImage,
        description: (
            <FormattedMessage
                defaultMessage="Connect your projects with the world."
                description="Description for the 'micro:bit' extension"
        ...
        launchPeripheralConnectionFlow: true,
        useAutoScan: false,
        peripheralImage: kaniPeripheralImage,
        smallPeripheralImage: kaniMenuImage,
        connectingMessage: (
            <FormattedMessage
                defaultMessage="Connecting"
                description="Message to help people connect to their micro:bit."
